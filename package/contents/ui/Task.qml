        ...
        id: frame
          ...
          anchors {
            ...
            topMargin: {
                ...
                let iconAlign = Math.round(parent.height - tasksRoot.iconSize * zoomFactor) - Kirigami.Units.smallSpacing
            ...
            leftMargin: {
                ...
                let iconAlign = Math.round(parent.width - tasksRoot.iconSize * zoomFactor) - Kirigami.Units.smallSpacing * 0.5
                let indicatorOffset = -Kirigami.Units.gridUnit / tasks.skinParams.positionTaskIndicator
    ...
    Loader {
        ...
        Loader {
            ...
            states: [
                ...
                State {
                    name: "standalone"
                    when: !tasksRoot.iconsOnly && !label.visible && task.parent
